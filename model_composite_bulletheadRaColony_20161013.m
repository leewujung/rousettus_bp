...
simu_data_path = 'model_bp_proj_RaColony_20161013_std1.0';
...
save_fname = sprintf('%s_%s_%s_%s_bin%d_th%d',...
    script_name,noise_std,model_freq_str,tongue_loc_str,binsize,threshold);
