...
pname='F:\small_space_beampattern\';
fname=[pname 'eptesicus_20150824_file_match.xlsx'];
save_dir=[pname 'proc_output_eptesicus\'];

% bandpass filter for use in click range estimation, only used when dura_flag=1
load('E:\repositories\beampattern_processing_wujung\bpf30.mat');
