...
simu_data_path = 'model_bp_proj_bullethead_20160804b_std2.0';
...
ss_save = strsplit(strtok(D.bp_model_file,'.'),'_');
save_fname = sprintf('%s_%s_%s',script_name,noise_std,strjoin({ss_save{end-3:end}},'_'));
