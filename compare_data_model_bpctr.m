...
%% Pairwise KS 2-sample and Mann-Whitney U-test for bpctr at each frequency
idx_left = data.click_side==0;
idx_right = data.click_side==1;
for iF = 1:length(freq_idx_wanted)

    %% Left clicks
    % KS 2-sample test
    % bpctr_opt = max
    [ks.h_data_piston_left(iF,1),ks.p_data_piston_left(iF,1)] = ...
        kstest2([data.bpctr(idx_left,freq_idx_wanted(iF)).max_az],...
                [piston.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).max_az]);
    [ks.h_data_phase_left(iF,1),ks.p_data_phase_left(iF,1)] = ...
        kstest2([data.bpctr(idx_left,freq_idx_wanted(iF)).max_az],...
                [model.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).max_az]);
    % bpctr_opt = top
    [ks.h_data_piston_left(iF,2),ks.p_data_piston_left(iF,2)] = ...
        kstest2([data.bpctr(idx_left,freq_idx_wanted(iF)).top_az],...
                [piston.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).top_az]);
    [ks.h_data_phase_left(iF,2),ks.p_data_phase_left(iF,2)] = ...
        kstest2([data.bpctr(idx_left,freq_idx_wanted(iF)).top_az],...
                [model.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).top_az]);
    % bpctr_opt = ectr
    [ks.h_data_piston_left(iF,3),ks.p_data_piston_left(iF,3)] = ...
        kstest2([data.bpctr(idx_left,freq_idx_wanted(iF)).ectr_az],...
                [piston.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).ectr_az]);
    [ks.h_data_phase_left(iF,3),ks.p_data_phase_left(iF,3)] = ...
        kstest2([data.bpctr(idx_left,freq_idx_wanted(iF)).ectr_az],...
                [model.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).ectr_az]);

    % Mann-Whitney U-test
    % bpctr_opt = max
    [mw.p_data_piston_left(iF,1),mw.h_data_piston_left(iF,1),mw.stat_data_piston_left(iF,1)] = ...
        ranksum([data.bpctr(idx_left,freq_idx_wanted(iF)).max_az],...
                [piston.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).max_az]);
    [mw.p_data_phase_left(iF,1),mw.h_data_phase_left(iF,1),mw.stat_data_phase_left(iF,1)] = ...
        ranksum([data.bpctr(idx_left,freq_idx_wanted(iF)).max_az],...
                [model.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).max_az]);
    % bpctr_opt = top
    [mw.p_data_piston_left(iF,2),mw.h_data_piston_left(iF,2),mw.stat_data_piston_left(iF,2)] = ...
        ranksum([data.bpctr(idx_left,freq_idx_wanted(iF)).top_az],...
                [piston.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).top_az]);
    [mw.p_data_phase_left(iF,2),mw.h_data_phase_left(iF,2),mw.stat_data_phase_left(iF,2)] = ...
        ranksum([data.bpctr(idx_left,freq_idx_wanted(iF)).top_az],...
                [model.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).top_az]);
    % bpctr_opt = ectr
    [mw.p_data_piston_left(iF,3),mw.h_data_piston_left(iF,3),mw.stat_data_piston_left(iF,3)] = ...
        ranksum([data.bpctr(idx_left,freq_idx_wanted(iF)).ectr_az],...
                [piston.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).ectr_az]);
    [mw.p_data_phase_left(iF,3),mw.h_data_phase_left(iF,3),mw.stat_data_phase_left(iF,3)] = ...
        ranksum([data.bpctr(idx_left,freq_idx_wanted(iF)).ectr_az],...
                [model.bpctr(idx_left,model_freqI(freq_idx_wanted(iF))).ectr_az]);
    ...
    % KS 2-sample test
    % bpctr_opt = max
    [ks.h_data_piston_right(iF,1),ks.p_data_piston_right(iF,1)] = ...
        kstest2([data.bpctr(idx_right,freq_idx_wanted(iF)).max_az],...
                [piston.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).max_az]);
    [ks.h_data_phase_right(iF,1),ks.p_data_phase_right(iF,1)] = ...
        kstest2([data.bpctr(idx_right,freq_idx_wanted(iF)).max_az],...
                [model.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).max_az]);
    % bpctr_opt = top
    [ks.h_data_piston_right(iF,2),ks.p_data_piston_right(iF,2)] = ...
        kstest2([data.bpctr(idx_right,freq_idx_wanted(iF)).top_az],...
                [piston.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).top_az]);
    [ks.h_data_phase_right(iF,2),ks.p_data_phase_right(iF,2)] = ...
        kstest2([data.bpctr(idx_right,freq_idx_wanted(iF)).top_az],...
                [model.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).top_az]);
    % bpctr_opt = ectr
    [ks.h_data_piston_right(iF,3),ks.p_data_piston_right(iF,3)] = ...
        kstest2([data.bpctr(idx_right,freq_idx_wanted(iF)).ectr_az],...
                [piston.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).ectr_az]);
    [ks.h_data_phase_right(iF,3),ks.p_data_phase_right(iF,3)] = ...
        kstest2([data.bpctr(idx_right,freq_idx_wanted(iF)).ectr_az],...
                [model.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).ectr_az]);

    % Mann-Whitney U-test
    % bpctr_opt = max
    [mw.p_data_piston_right(iF,1),mw.h_data_piston_right(iF,1),mw.stat_data_piston_right(iF,1)] = ...
        ranksum([data.bpctr(idx_right,freq_idx_wanted(iF)).max_az],...
                [piston.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).max_az]);
    [mw.p_data_phase_right(iF,1),mw.h_data_phase_right(iF,1),mw.stat_data_phase_right(iF,1)] = ...
        ranksum([data.bpctr(idx_right,freq_idx_wanted(iF)).max_az],...
                [model.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).max_az]);
    % bpctr_opt = top
    [mw.p_data_piston_right(iF,2),mw.h_data_piston_right(iF,2),mw.stat_data_piston_right(iF,2)] = ...
        ranksum([data.bpctr(idx_right,freq_idx_wanted(iF)).top_az],...
                [piston.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).top_az]);
    [mw.p_data_phase_right(iF,2),mw.h_data_phase_right(iF,2),mw.stat_data_phase_right(iF,2)] = ...
        ranksum([data.bpctr(idx_right,freq_idx_wanted(iF)).top_az],...
                [model.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).top_az]);
    % bpctr_opt = ectr
    [mw.p_data_piston_right(iF,3),mw.h_data_piston_right(iF,3),mw.stat_data_piston_right(iF,3)] = ...
        ranksum([data.bpctr(idx_right,freq_idx_wanted(iF)).ectr_az],...
                [piston.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).ectr_az]);
    [mw.p_data_phase_right(iF,3),mw.h_data_phase_right(iF,3),mw.stat_data_phase_right(iF,3)] = ...
        ranksum([data.bpctr(idx_right,freq_idx_wanted(iF)).ectr_az],...
                [model.bpctr(idx_right,model_freqI(freq_idx_wanted(iF))).ectr_az]);
