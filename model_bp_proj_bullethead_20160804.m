...
bp_model_path = 'F:\Dropbox\0_ANALYSIS\bp_bem_modeling\model_bp_save_20160804';
bp_model_file = 'model_bp_save_20160804_35kHz_x001_y006_z000.mat';
BP = load(fullfile(bp_model_path,bp_model_file));

% Load model prediction
idxnotnan = ~isnan(BP.pp_plot);
[~,BP.vq_norm,BP.azq,BP.elq] = interp_bp(BP.az(idxnotnan)/180*pi,BP.el(idxnotnan)/180*pi,BP.pp_plot(idxnotnan),'rbf');
