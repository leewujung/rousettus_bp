function [raw,shift_max,shift_elpctr,shift_elpctr_tilt] = ...
        shift_rotate_bp_composite(azq,elq,vq_norm,map_proj,it_shift_th)
...
% shift_elpctr_tilt.x = x_ecen_tilt;      % commented 2016/10/25
...
shift_elpctr_tilt.azq = azq_ecen_tilt;  % commented 2016/10/25
...
[~,vq_norm_re,azq_re,elq_re] =...
    interp_bp(azq_ecen_tilt/180*pi,elq_ecen_tilt/180*pi,vq_norm,'rbf');
