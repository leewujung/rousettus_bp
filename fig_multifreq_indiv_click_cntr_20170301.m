...
if strcmp(usrn,'Wu-Jung')
    data_base_path = 'F:\Dropbox\0_ANALYSIS\bp_processing\proc_output_rousettus_new';
    save_base_path = 'F:\Dropbox\Z_wjlee\projects\rousettus_bp';
else
    data_base_path = ['C:\Users\',usrn,'\Dropbox\0_ANALYSIS\bp_processing\proc_output_rousettus_new'];
