...
diff_data_path = 'model_bp_proj_RaColony_multiple_diffonly_20170924';
...
for iS=1:length(diff_file)
    ...
    for iF=1:length(freq_all)
        ...
        sbp = strsplit(D.bp_model_file.name,'_');
        bp_model_file = strjoin([sbp(1:7),sprintf('%dkHz',freq_model/1e3),sbp(9:end)],'_');
