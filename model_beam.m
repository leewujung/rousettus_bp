...
%   mic_azel   az,el position of mic from experimental data
% OUTPUT
...
%         pol_angle(pol_angle>pi/2) = NaN;
        mic_dB = abs(2*besselj(1,bp_info.k*bp_info.a*sin(pol_angle))./...
                     (bp_info.k*bp_info.a*sin(pol_angle)));
        mic_dB(pol_angle==0) = 0;
    case 'gaussian'
        mic_dB = normpdf(pol_angle,bp_info.mu,bp_info.sigma);
end
